...
const ExpensePieChart = () => {
    ...
    return (
        <div className="bg-[var(--bg-card)] rounded-2xl p-6 shadow-lg border border-[var(--border-color)]">
            ...
            <div className="h-[300px] relative">
                <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                        ...
                        <Tooltip
                            contentStyle={{ backgroundColor: '#c4d2e7ff', border: '1px solid #334155', borderRadius: '8px' }}
                        />
                    </PieChart>
                </ResponsiveContainer>
