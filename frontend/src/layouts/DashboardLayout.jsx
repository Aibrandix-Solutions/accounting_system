...
const DashboardLayout = () => {
    ...
    const navigation = [
        ...
        { name: 'Companies', icon: Building2, path: '/company-management' },
        {
            name: 'Bills',
            icon: Receipt,
            children: [
                { name: 'Invoice Bills', icon: Receipt, path: '/invoice-bills' },
                { name: 'Vendor Bills', icon: ScrollText, path: '/vendor-bills' },
            ]
        },
        { name: 'Admins', icon: Shield, path: '/admin-management' },
        { name: 'Users', icon: Users, path: '/user-management' },
        { name: 'Permissions', icon: Lock, path: '/permission-management' },
